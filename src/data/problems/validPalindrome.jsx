  ...
  return (
    <svg viewBox="0 0 800 380" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
      ...
      <g transform="translate(300, 364)">
        <text x="0" y="2" fontFamily="JetBrains Mono, monospace" fontSize="20" fill="#57534e" letterSpacing="1">return</text>
        <rect x="86" y="-17" width="76" height="34" fill="#dcfce7" stroke="#15803d" strokeWidth="1.5" rx="3" />
        <text x="124" y="2" textAnchor="middle" fontFamily="JetBrains Mono, monospace" fontSize="21" fontWeight="700" fill="#15803d">true</text>
      </g>
